// Create variables //
const apiKey = "b79ca2075dc30fbde3e7044a167b6a51"
...
let weatherApiURL = `https://api.openweathermap.org/data/2.5/forecast?q= ${city} &appid= apiKey;`
let GeoAPIURL = "https://api.openweathermap.org/data/2.5/forecast?lat={lat}&lon={lon}&appid={API key}";
...
// This function serves as a save for city search history, that is then saved to local storage //
function updateCityHistory(searchInput) {
  localStorage.setItem("city_history")
  printCityHistory();
}
// Calling function to load search history //
printCityHistory();